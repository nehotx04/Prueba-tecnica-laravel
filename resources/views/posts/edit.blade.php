    ...
    <form action="{{route('posts.update',$post)}}" method="post">
        ...
        @csrf
            <div class="mb-4">
                ...
                <input name="title" value="{{old('title',$post->title)}}" type="text" class="form-control" required>
            </div>
                <div class="form-floating mb-4">
                    <textarea class="form-control" name="body" placeholder="Escribe el contenido de tu publicacion" id="floatingTextarea">
                        {{old('body',$post->body)}}
                    </textarea>
